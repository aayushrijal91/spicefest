...
<section class="main">
    <div class="container d-md-none pb-4">
        <div class="row justify-content-center g-2">
            <div class="col-6">
                <div class="bg-primary p-2 d-flex justify-content-center align-items-center">
                    <div class="text-gradient-red h11">Date</div>
                    <div class="font-gothic h8 ps-2 ps-md-3 fw-900 letter-spacing-n07">7 August 2022</div>
                </div>
            </div>
            <div class="col-6">
                <div class="bg-primary p-2 d-flex justify-content-center align-items-center">
                    ...
                    <div class="row gy-4 gy-lg-5 gy-xl-0 gx-4">
                            ...
                            <div class="category-card">
                                ...
                                <div class="title">
                                    <span class="d-md-none">
                                        <svg width="24" height="30" viewBox="0 0 41 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="col-xl-6 h-inherit">
                            <div class="category-card">
                                ...
                                <div class="title">
                                    <span class="d-md-none">
                                        <svg width="25" height="27" viewBox="0 0 44 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="window win2">
                                    <a class="btn h16 px-md-5 py-3 button" target="_blank" href="https://linktr.ee/spicefest">Book Tickets</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="festival-overview">
        <div class="container">
            <div class="d-flex align-items-center flex-column w-100">
                ...
                <div class="pt-4 d-md-none"><?= renderImg("holi-img.png", "lib") ?></div>
            </div>
            <div class="row justify-content-center pt-4 d-none d-md-flex">
                <div class="col-auto">
                    <div class="festival-floating-img">
                        <?= renderImg("fest-1.png", "lib", "fest-1") ?>
                        <?= renderImg("fest-2.png", "lib", "fest-2") ?>
                        <?= renderImg("fest-3.png", "lib", "fest-3") ?>
                        <?= renderImg("fest-4.png", "lib", "fest-4") ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="indoor-event-inclusion" id="indoor-events">
        <div class="container position-relative">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-xl-11">
                    <div class="d-md-none"><?= renderImg("indoor-events-inclusion-sm.jpg", "lib", "w-100") ?></div>
                    <div class="d-none d-md-block"><?= renderImg("indoor-event-inclusion.jpg", "lib", "w-100") ?></div>
                    <div class="content">
    ...
    <div class="bottom-section" id="what-to-expect">
        ...
        <div class="variety">
            <div class="container">
                <div class="row justify-content-center justify-content-center justify-content-md-start">
                    <div class="col-12 col-xl-11">
                        <div class="h4 text-dark pb-5 d-flex align-items-center">
                            <div>
                            ...
                            <div class="ps-3">Cuisines From All Around The World</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="variety">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-11">
                        <div class="h4 text-dark pb-5 d-flex align-items-center justify-content-center justify-content-md-start">
                            <div>
                            ...
                            <div class="ps-3">Children Entertainment</div>
                        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-11">
                        <div class="h4 text-dark pb-5 d-flex align-items-center justify-content-center justify-content-md-start">
                            ...
                            <div class="ps-3">Main Dances</div>
                        </div>
                    </div>
                </div>
            </div>
